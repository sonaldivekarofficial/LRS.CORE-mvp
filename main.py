...
def detect_recursions(responses, element_scores):
    # Extract scores from all 70 questions
    vital_score = element_scores["Vitality"]
    conn_score = element_scores["Connection"]
    env_score = element_scores["Environment"]
    growth_score = element_scores["Growth"]
    stab_score = element_scores["Stability"]
    mean_score = element_scores["Meaning"]
